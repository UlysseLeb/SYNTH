...
public:
    ...
    //  Récupère les paramètres ADSR du filtre (NOUVEAU!)
    ...
    //  Structure pour regrouper les paramètres du filtre
    ...
    //  Crée l'interface graphique du plugin
    ...
    //  Durée de la "queue" audio après arrêt (ex: reverb)
...
private:
    ...
    //  parameters : arbre de paramètres (ADSR, filtre, etc.)
    ...
    //  Fonction statique pour créer la structure des paramètres
