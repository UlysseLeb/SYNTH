...
{
public:
    // 🏗️ Constructeur : initialise la voix (valeurs par défaut dans private)
    SynthVoice()
    {
    ...
    // 🎚️ ÉVÉNEMENTS MIDI (non utilisés ici, mais obligatoires)
    ...
    // 🎛️ MISE À JOUR DE L'ENVELOPPE ADSR (Amplitude)
    ...
    // 🎚️ MISE À JOUR DE L'ENVELOPPE ADSR DU FILTRE (NOUVEAU!)
    ...
    // 🎚️ MISE À JOUR DES PARAMÈTRES UNISON
...
private:
    ...
    // 🎚️ filterAdsr : enveloppe ADSR dédiée au filtre (NOUVEAU!)
    ...
    // 🎚️ filter : filtre audio (State Variable TPT = Topology-Preserving Transform)
    ...
    // 🎚️ Paramètres du filtre stockés pour la modulation
